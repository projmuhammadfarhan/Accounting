...
function numberFormatRupiah(number) {
    return new Intl.NumberFormat('id-ID').format(parseFloat(number).toFixed(2));
}
//Invoice Paid Amount
    "use strict";
function invoice_paidamount() {
 ...
 var nt = 0;
    ...
    $("#add_new_payment").empty();
    $("#pay-amount").text('0');
    $("#n_total").val(numberFormatRupiah(nt));
	
    $("#net_total_text").text(numberFormatRupiah(nt));  
        
     if(e > 0){
    $("#dueAmmount").val(numberFormatRupiah(f));
    $("#due_text").text(numberFormatRupiah(f));
    if(a <= f){
     $("#change").val(0);   
    }
}else{
