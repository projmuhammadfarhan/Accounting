                            ...
                            <table class="print-font-size" width="100%">
                                <tr>
                                    <td align="left" width="33.333%">
                                        ...
                                        echo base_url().$setting->logo; 
                                        } ?>"
                                            class="img-bottom-m print-logo" width="100px" alt="logo">
                                    </td>
                    ...
                    <table width="99%" align="center"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $currency. ' '. number_format($resultDebit,2,'.',',') ;?> </td>
                                <td><?php echo $currency. ' '. number_format($resultCredit,2,'.',',') ;?> </td>
