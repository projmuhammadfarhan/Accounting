...
<div class="row">
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
        <div class="small-box bg-green whitecolor">
            <div class="inner">
                <h4><span class="count-number"><?php echo number_format($total_customer, 0, ',', '.') ?></span></h4>
...
<div class="col-sm-10 col-md-10 d-flex">
        <div class="panel panel-bd flex-fill w-100"><div class="panel-body">  <h3><script>
                                                var today = new Date()
                                                ...
                                                </script>, <?php echo $this->session->userdata('fullname') ?></h3>
                                                Shortcut<br/>
                                                <a href="<?php echo base_url("add_invoice"); ?>" class="btn btn-info">Create new sales</a>
                                                <a href="<?php echo base_url("gui_pos"); ?>" class="btn btn-warning">Open POS Cashier</a>
                                                <a href="<?php echo base_url("add_purchase"); ?>" class="btn btn-success">Create new Purchase</a>
 </div></div>

<div class="col-sm-2 col-md-2 d-flex"><img src="<?php echo base_url('assets/side.png'); ?>" />
</div>
</div>
</div>
<hr>
...
<div class="row d-flex flex-wrap">
    ...
    <!-- <?php echo html_escape(number_format($this->home_model->total_sales_amount($searchdate)), 0, ',', '.')?> -->
