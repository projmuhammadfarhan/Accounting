                    ...
                    <div id="printableArea">
                        <div class="panel-body">
                               ...
                               <tbody>
                                  ...
                                  <td align="left"><nobr><?php echo html_escape($invoice_data['unit']);?></nobr></td>
                                    ...
                                    <nobr>
                                        <?php 
                                         if($position == 0){
                                       echo  $currency.' '.html_escape(number_format($invoice_data['rate'], 0, ',', '.'));
                                    }else{
                                    ...
                                    <nobr>
                                        <?php 
                                       if($position == 0){
                                       echo  $currency.' '.html_escape(number_format($invoice_data['total_price'], 0, ',', '.'));
                                    }else{
                                    echo html_escape(number_format($invoice_data['total_price'], 0, ',', '.')).' '.$currency;
                                    }
                          ...
                          <tfoot>
                                    ...
                                    <td align="right">
                                    <b>
                                        <?php echo html_escape((($position == 0) ? $currency.' '.number_format($total_discount, 0, ',', '.') : $total_discount.' '.$currency)) ?>
                                    </b></td>
                                    </tr>
                                    <tr>
                                        <td colspan="12" class="minpos-bordertop"><nobr></nobr></td>
                                    ...
                                    <tr>
                                        <td align="left"><nobr></nobr></td>
                                    <td colspan="9"></td><td align="right"><strong><?php echo display('grand_total')?></strong></td>
