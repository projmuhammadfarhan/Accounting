            ...
            <div id="printableArea">
                ...
                foreach($invoice_all_data as $invoice_data){?>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center"
                            ...
                            <tbody>
                                <tr>
                                    <th style="text-align: left;"><?php echo number_format($itemrow, 0, ',', '.');?>
                                    </th>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px"><?php echo display('tot_before_dis'); ?></th>
                                </tr>
                                <tr>
                                    <th style="text-align: left;"><?php echo number_format($all_discount, 0, ',', '.'); ?></th>
                                ...
                                <?php if($total_vat > 0){?>
                                <tr>
                                    <th style="text-align: left;"><?php echo number_format($total_vat, 0, ',', '.'); ?></th>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px"><?php echo display('vat_val'); ?></th>
                                </tr>
                                <?php } 
                                if($total_tax > 0){?>
                                <tr>
                                    <th style="text-align: left;"><?php echo number_format($total_tax, 0, ',', '.'); ?></th>
                                    <th style="text-align: right;padding: 3px 10px 3px 0px"><?php echo display('tax_vat'); ?></th>
                                </tr>
                                <?php } ?>
                                <tr>
                                    <th style="text-align: left;"><span
                                            style="font-size: 16px;font-weight: 900;"><?php echo number_format($grand_total, 0, ',', '.'); ?></span>
                                    </th>
