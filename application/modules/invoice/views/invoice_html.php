                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="comp-web" align="right">
                                        <?php echo (($position == 0) ? $currency.' '.number_format($details['discount_per'], 0, ',', '.') : number_format($details['discount_per'], 0, ',', '.').' '. $currency) ?>
                                    </td>
                                    <?php } ?>
                                    ...
                                    <td class="comp-web" align="right">
                                        <?php echo (($position == 0) ? $currency.' '.number_format($details['total_price'], 0, ',', '.') : number_format($details['total_price'], 0, ',', '.').' '. $currency) ?>
                                    </td>
                                </tr>
                                <?php }?>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?php
                                         ...
                                         echo (($position == 0) ? $currency.' '.number_format($itemprice - ($total_discount_cal?$total_discount_cal:0), 0, ',', '.') : number_format($itemprice - ($total_discount_cal?$total_discount_cal:0), 0, ',', '.').' '.$currency) ?>
                                    </td>
                                </tr>
                                <?php
