<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li class="treeview <?php
            ...
            ?>">
            <a href="#">
                <i class="fa fa-shopping-cart"></i><span><?php echo display('invoice') ?></span>
 ...
 <!-- supplier menu part -->
        ...
        <li
            ...
            <a href="javascript:void(0)">
                ...
                <i class="metismenu-icon fa fa-users"></i> <span><?php echo display('supplier') ?></span>
                <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                </span>
            </a>
        ...
        <li class="treeview <?php
            ...
            ?>">
                    <a href="#">
                        <i class="fa fa-money"></i><span><?php echo display('payroll') ?></span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
