            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table">
                            <tr>
                                <th><?php echo display('total_purchase') ?> = <span class="text-danger"><?php echo number_format($total_purchase, 0, ',', '.'); ?></span></th>
                                <th><?php echo display('total_sales') ?> = <span class="text-danger"> <?php echo number_format($total_sales, 0, ',', '.'); ?></span></th>
                                <th><?php echo display('stock') ?> = <span class="text-danger"> <?php echo number_format($stock, 0, ',', '.');?></span></th>
                            </tr>
                        </table>
                    </div>
                </div>
                                    ...
                                    if ($purchaseData) {
                                       ...
                                       <?php foreach($purchaseData as $purchasedata){?>
                                        <tr>
                                            ...
                                            <td  class="text-right"><?php echo number_format($purchasedata['quantity'], 0, ',', '.'); ?></td>
                                            <td  class="text-right"><?php echo (($position == 0) ? $currency.' '.number_format($purchasedata['rate'], 0, ',', '.') : number_format($purchasedata['rate'], 0, ',', '.').' '. $currency) ?></td>
                                            <td class="text-right"> <?php echo (($position == 0) ? $currency.' '.number_format($purchasedata['total_amount'], 0, ',', '.') : $purchasedata['total_amount'].' '.$currency) ?></td>
                                        </tr>
                                      <?php }?>
                                        <?php
                                    }else{
