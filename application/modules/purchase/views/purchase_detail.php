                    ...
                    <table class="table table-striped print-font-size">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-right comp-web"><?php echo number_format($details['quantity'], 0, ',', '.'); ?></td>
                                <td class="text-right comp-web">
                                    <?php echo (($position==0)?$currency.' '.number_format($details['rate'], 0, ',', '.'):number_format($details['rate'], 0, ',', '.').' '.$currency) ?>
                                </td>
                                <td class="text-right comp-web">
                                    <?php echo (($position==0)?number_format($details['discount'], 0, ',', '.'):number_format($details['discount'], 0, ',', '.')) ?></td>
                                <td class="text-right comp-web">
                                    <?php echo (($position==0)?$currency.' '.number_format($details['discount_amnt'], 0, ',', '.'):number_format($details['discount_amnt'], 0, ',', '.').' '.$currency) ?>
                                </td>
                                <td class="text-right comp-web">
                                    <?php echo (($position==0)?number_format($details['vat_amnt_per'], 0, ',', '.'):number_format($details['vat_amnt_per'], 0, ',', '.')) ?>
                                </td>
                                <td class="text-right comp-web">
                                    <?php echo (($position==0)?$currency.' '.number_format($details['vat_amnt'], 0, ',', '.'):number_format($details['vat_amnt'], 0, ',', '.').' '.$currency) ?>
                                </td>
                                <td class="text-right comp-web">
                                    <?php echo (($position==0)?$currency.' '.number_format($details['total_amount'], 0, ',', '.'):number_format($details['total_amount'], 0, ',', '.').' '.$currency) ?>
                                </td>
                            </tr>
