                        ...
                        foreach ($quotation_list as $quotation) {
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <?php echo html_escape((($position == 0) ? $currency ." ".number_format($quotation->item_total_amount, 0, ',', '.') : "$quotation->item_total_amount $currency")); ?>
                                </td>
                                 <td class="text-right">
                                    <?php echo html_escape((($position == 0) ? $currency ." ".number_format($quotation->service_total_amount, 0, ',', '.') : "$quotation->service_total_amount $currency")); ?>
                                </td>
                                <td><?php
