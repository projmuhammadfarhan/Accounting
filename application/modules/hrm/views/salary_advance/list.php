                        ...
                        <?php if (!empty($salary_adv_list)) { ?>
                            ...
                            <?php foreach ($salary_adv_list as $salary_adv) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                    ...
                                    <td><?php echo $setting->currency.' '.number_format($salary_adv->amount, 0, ',', '.'); ?></td>
                                    <td><?php echo $setting->currency.' ';?><?php echo $salary_adv->release_amount > 0 ? number_format($salary_adv->release_amount, 0, ',', '.') : 0; ?></td>
