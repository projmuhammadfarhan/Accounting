                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr style="text-align: center;">
                                ...
                                <td><?php echo $currency.' '.number_format($gross_salary, 0, ',', '.') ;?></td>
                                <td></td>
                            </tr>
                            <tr style="text-align: center;">
                                <th style="text-align: center;">Net Salary</th>
                                <td></td>
                                <td><?php echo $currency.' '.number_format($net_salary, 0, ',', '.'); ?></td>
                            </tr>
                            <tr style="text-align: center;">
                                <th style="text-align: center;">Loans</th>
                                <td></td>
                                <td><?php echo $currency.' '.number_format($loans, 0, ',', '.');?></td>
                            </tr>
                            <tr style="text-align: center;">
                                <th style="text-align: center;">Salary Advance</th>
                                <td></td>
                                <td><?php echo $currency.' '.number_format($salary_advance, 0, ',', '.') ;?></td>
                            </tr>
                            <tr style="text-align: center;">
                                <th style="text-align: center;">State Income Tax</th>
                                <td></td>
                                <td><?php echo $currency.' '.number_format($state_income_tax, 0, ',', '.') ;?></td>
                            </tr>
                            <tr style="text-align: center;">
